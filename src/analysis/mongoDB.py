...
import pymongo
import pymongo.errors # se importa de la biblioteca pymongo mongoclient
...
# def insert_document (db, products_analysis, document):
...
# def analyze_data.to_dict() # lo intenté profe :( 
...
# coneccion a mongoDB 
# url = 'mongodb+srv://jenrous26:rCsyWCd4obzR0nm8@cluster0.tkel23i.mongodb.net/'
# name_data_base = 'Deber'
# db = connect_mongodb (url, name_data_base)

# analyze_data.to_dict() # 

# highest_prices = []

# highest_prices_data = highest_prices.to_dict(orient='records')
